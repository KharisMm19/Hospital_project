 ...
 * @author ASUS
 */
public class DischargeRec1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DischargeRec1
     */
    public DischargeRec1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DischargeRec1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DischargeRec1().setVisible(true);
            }
        });
    }
