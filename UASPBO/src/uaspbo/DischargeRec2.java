 ...
 * @author ASUS
 */
public class DischargeRec2 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DischargeRec2
     */
    public DischargeRec2() {
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Date endDate = (Date) sdf.parse(add18);
                Date startDate = (Date) sdf.parse(add11);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DischargeRec2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DischargeRec2().setVisible(true);
            }
        });
    }
