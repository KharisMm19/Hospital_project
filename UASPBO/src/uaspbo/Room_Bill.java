 ...
 * @author ASUS
 */
public class Room_Bill extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.hide();
        DischargeRec2 frm = new DischargeRec2();
        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Room_Bill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
