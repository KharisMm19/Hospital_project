 ...
 * @author ASUS
 */
public class BillRec extends javax.swing.JFrame {

    Connection con=null;    
    ResultSet rs=null;
    PreparedStatement pst=null;
    /**
     * Creates new form BillRec
     */
    public BillRec() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillRec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
